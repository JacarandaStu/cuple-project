...
1. 游戏加载界面，设计了加载的样式（或许可以让其动起来）:<br>![这是图片](/images/加载中1.png)
2. 游戏主界面，综合所有模块于一体的中心部分：<br>![这是图片](/images/主界面.png)
3. 游戏引导教程，带领新玩家快速入门了解规则：<br>![这是图片](/images/弹窗：规则介绍.png)
4. 对战界面，将三个模式的游戏界面融合到了一体：<br>![这是图片](/images/对局画面1.png)
5. 商店模块，微不足道的创新点，万恶的小游戏必备的皮肤销售环节：<br>![这是图片](/images/弹窗：更多骰子.png)![这是图片](/images/弹窗：更多棋盘.png)
